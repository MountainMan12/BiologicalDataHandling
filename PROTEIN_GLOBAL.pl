...
my $string_filename1 = "CAA35120.1.fasta";  #CHANGE FILENAME
...
my $string_filename2 = "AIF94846.fasta";  #CHANGE FILENAME
...
my $filename = 'PROTEIN_GLOBAL.txt';
